...
//         <aside className="hidden md:block md:w-64 lg:w-75 bg-yellow-600 min-h-screen p-8 mt-8 "></aside>
...
//           <div className="flex-1 w-full pl-6 md:pl-64 lg:pl-[20rem]">
//             <ul className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-center bg-white min-h-screen w-[90%] sm:gap-2 sm:m-2 lg:gap-6 md:gap-6  lg:m-8 md:6">
//               {products.length > 0 ? (
